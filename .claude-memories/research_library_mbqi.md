...
**2026-07-06 expansion → 21 PDFs** (#404-R/#408 research-first phase for the priority/relevance instantiation redesign): added 8 fuel/scheduling/stability papers — Simplify (Detlefs-Nelson-Saxe 2005, the ancestor), **the fuel canon** (Amin-Leino-Rompf TAP 2014, F★ Swamy+ POPL 2016, **Verus** Lattuada+ OOPSLA 2023 = the exact system that made our corpus), matching-loop DETECTION (Becker-Müller-Summers 2019 axiom-profiler), instability measurement (Mariposa FMCAD 2023 + **Cazamariposas** CADE 2025 EXCESS/DEFICIT + causal-root), Verus `broadcast` (2025). Synthesis memo = **`FUEL_AWARE_INSTANTIATION_RESEARCH.md`** in the library — grounds the redesign; see [[mbqi-term-growth-throttle]].
