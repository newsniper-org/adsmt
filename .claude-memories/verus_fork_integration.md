...
description: Verus fork (~/verus-fork) consumes lu-smt as an SMT backend via `verus -V adsmt`; the rc.7→rc.19 arc has been driven by closing the gap end-to-end. rc.10 hash-cons; rc.12 T0; rc.13/14 §3.4 Buchberger+F4+plugin; rc.15 §3.1.A-D + §3.2/§3.3 skeletons + §3.4 CLI; rc.16 §3.5.A-G end-to-end + T0'.1-.3; rc.17 promoted every §3.5 v0 skeleton to v0.x + §3.2 dynasm-rs + §3.3 phase 2 + Stålmarck trailing section; rc.18 verus-fork rc.17 retry follow-ups; rc.19 verus-fork rc.18 retry follow-ups (3 fixes): (a') unified PoolBuilder for v0+v1 bake sections + (b') CLI start/take_jit_recording wiring + (c') drop redundant intern_external on v0 load path.  Next gate stays on verus-fork — §3.5.J full retry now unblocked on every CLI prerequisite.
type: project
