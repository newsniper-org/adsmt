...
| What | Where |
|---|---|
| Project version | `1.0.0-rc.39.1` (testing channel; cuts to `v1.0.0` stable on explicit sign-off) |
...
## Workspace topology (v1.0.0-rc.39.1)
