...
| What | Where |
|---|---|
| Project version | `1.0.0-rc.28` (testing channel; cuts to `v1.0.0` stable on explicit sign-off) |
...
| Tests | **951** passing across the workspace; 0 `cargo doc` / `cargo build` warnings (rc.28 added 2 AOT-soundness regression tests) |
...
## Workspace topology (v1.0.0-rc.28)
...
The rc.7 → rc.28 arc has been driven by the verus-fork
