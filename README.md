...
| What | Where |
|---|---|
| Project version | `1.0.0-rc.30` (testing channel; cuts to `v1.0.0` stable on explicit sign-off) |
...
| Tests | **970** passing across the workspace; 0 `cargo doc` / `cargo build` warnings (rc.30 added datatype + bit-vector surface tests) |
...
## Workspace topology (v1.0.0-rc.30)
...
The rc.7 → rc.30 arc has been driven by the verus-fork
