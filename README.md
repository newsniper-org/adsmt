...
| What | Where |
|---|---|
| Project version | `1.0.0-rc.34` (testing channel; cuts to `v1.0.0` stable on explicit sign-off) |
...
| Tests | **1069** passing across the workspace; 0 `cargo doc` / `cargo build` warnings (rc.34 closed the §3.5 JIT-on-AOT trace-replay sub-cycle on adsmt's side) |
...
## Workspace topology (v1.0.0-rc.34)
