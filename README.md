...
| What | Where |
|---|---|
| Project version | `1.0.0-rc.20` (testing channel; cuts to `v1.0.0` stable on explicit sign-off) |
...
## Workspace topology (v1.0.0-rc.20)
...
The rc.7 → rc.20 arc has been driven by the verus-fork
