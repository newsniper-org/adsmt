...
| What | Where |
|---|---|
| Project version | `1.0.0-rc.21` (testing channel; cuts to `v1.0.0` stable on explicit sign-off) |
...
## Workspace topology (v1.0.0-rc.21)
...
The rc.7 → rc.21 arc has been driven by the verus-fork
