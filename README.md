...
| What | Where |
|---|---|
| Project version | `1.0.0-rc.29` (testing channel; cuts to `v1.0.0` stable on explicit sign-off) |
...
| Tests | **956** passing across the workspace; 0 `cargo doc` / `cargo build` warnings (rc.29 added Tseitin OR-of-AND completeness tests) |
...
## Workspace topology (v1.0.0-rc.29)
